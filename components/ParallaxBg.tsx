...
export default function ParallaxBg() {
    ...
    // return (
    //   <div className='h-screen border-4 border-red-500 overflow-hidden'>
    ...
    return (
        ...
        <div className='relative z-10 p-20 mix-blend-difference text-white  flex flex-col justify-between'>
